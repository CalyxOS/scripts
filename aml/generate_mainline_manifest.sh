...
readonly default_aosp_remote_url="https://android.googlesource.com/"
...
readonly aosp_project_format="platform/%s"
readonly xml_auto_gen_line='<!-- Automatically generated by '"$script_name"' -->'
readonly default_calyx_remote_url="ssh://git@gitlab.com" # - eventually https://gitlab.com ?
readonly calyxos_project_format="CalyxOS/tmp/platform_%s" # - /tmp is temporary!
...
AOSP_REMOTE_URL="${AOSP_REMOTE_URL:-$default_aosp_remote_url}"
...
generate_aosp_manifest() {
  ...
  local aosp_remote_expr='s!(<remote name="aosp" fetch=")\.\."!\1'"$AOSP_REMOTE_URL"'"!'
