...
fastboot flash --slot=other bootloader bootloader-panther-cloudripper-15.1-12292122.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other bootloader bootloader-panther-cloudripper-15.1-12292122.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-panther-g5300q-240919-241106-B-12612898.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-panther-g5300q-240919-241106-B-12612898.img
fastboot --set-active=other reboot-bootloader
...
fastboot --skip-reboot -w update image-panther-ap4a.250205.002.zip
