...
fastboot flash --slot=other bootloader bootloader-oriole-slider-1.3-11403664.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other bootloader bootloader-oriole-slider-1.3-11403664.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-oriole-g5123b-130914-240205-B-11405587.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-oriole-g5123b-130914-240205-B-11405587.img
fastboot --set-active=other reboot-bootloader
