...
fastboot flash --slot=other bootloader bootloader-oriole-slider-15.1-12292109.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other bootloader bootloader-oriole-slider-15.1-12292109.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-oriole-g5123b-143112-241107-B-12620021.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-oriole-g5123b-143112-241107-B-12620021.img
fastboot --set-active=other reboot-bootloader
...
fastboot --skip-reboot -w update image-oriole-ap4a.250205.002.zip
