...
if ! fastboot getvar product 2>&1 | grep "^product: shiba$"; then
  echo "Factory image and device do not match. Please double check"
  exit 1
fi
fastboot flash --slot=other bootloader bootloader-shiba-ripcurrent-15.1-12474670.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other bootloader bootloader-shiba-ripcurrent-15.1-12474670.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-shiba-g5300i-240919-241106-B-12612898.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-shiba-g5300i-240919-241106-B-12612898.img
fastboot --set-active=other reboot-bootloader
...
fastboot --skip-reboot -w update image-shiba-ap4a.250205.002.zip
