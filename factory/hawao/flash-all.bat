...
fastboot getvar product 2>&1 | findstr /r /c:"^product: hawao" || echo "Factory image and device do not match. Please double check"
fastboot getvar product 2>&1 | findstr /r /c:"^product: hawao" || exit /B 1
...
fastboot --skip-reboot -w update image-hawao-ap1a.240405.002.a1.zip || exit /B 1
