...
fastboot flash --slot=other bootloader bootloader-akita-akita-15.1-12474670.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other bootloader bootloader-akita-akita-15.1-12474670.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-akita-g5300o-240919-241106-B-12612898.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-akita-g5300o-240919-241106-B-12612898.img
fastboot --set-active=other reboot-bootloader
...
fastboot --skip-reboot -w update image-akita-ap4a.250205.002.zip
