...
fastboot flash --slot=other bootloader bootloader-felix-felix-14.4-11458464.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other bootloader bootloader-felix-felix-14.4-11458464.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-felix-g5300q-231218-240202-B-11396366.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-felix-g5300q-231218-240202-B-11396366.img
fastboot --set-active=other reboot-bootloader
