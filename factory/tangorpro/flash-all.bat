...
fastboot flash --slot=other bootloader bootloader-tangorpro-tangorpro-15.1-12292122.img || exit /B 1
...
fastboot --skip-reboot -w update image-tangorpro-ap4a.250205.002.zip || exit /B 1
