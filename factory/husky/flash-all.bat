...
fastboot flash --slot=other bootloader bootloader-husky-ripcurrent-15.1-12474670.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other bootloader bootloader-husky-ripcurrent-15.1-12474670.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other radio radio-husky-g5300i-240919-241106-B-12612898.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other radio radio-husky-g5300i-240919-241106-B-12612898.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
...
fastboot --skip-reboot -w update image-husky-ap4a.250205.002.zip || exit /B 1
