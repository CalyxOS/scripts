...
fastboot flash --slot=other bootloader bootloader-husky-ripcurrent-15.1-12474670.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other bootloader bootloader-husky-ripcurrent-15.1-12474670.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-husky-g5300i-240919-241106-B-12612898.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-husky-g5300i-240919-241106-B-12612898.img
fastboot --set-active=other reboot-bootloader
...
fastboot --skip-reboot -w update image-husky-ap4a.250205.002.zip
