...
fastboot flash --slot=other bootloader bootloader-husky-ripcurrent-14.4-11403750.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other bootloader bootloader-husky-ripcurrent-14.4-11403750.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-husky-g5300i-231218-240202-B-11396366.img
fastboot --set-active=other reboot-bootloader
sleep 5
fastboot flash --slot=other radio radio-husky-g5300i-231218-240202-B-11396366.img
fastboot --set-active=other reboot-bootloader
