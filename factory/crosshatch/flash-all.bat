...
fastboot flash --slot=other bootloader bootloader-crosshatch-b1c1-0.4-7617406.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other bootloader bootloader-crosshatch-b1c1-0.4-7617406.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other radio radio-crosshatch-g845-00194-210812-B-7635520.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other radio radio-crosshatch-g845-00194-210812-B-7635520.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
...
fastboot --skip-reboot -w update image-crosshatch-ap1a.240405.002.a1.zip || exit /B 1
