...
fastboot flash --slot=other bootloader bootloader-lynx-lynx-15.1-12292122.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other bootloader bootloader-lynx-lynx-15.1-12292122.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other radio radio-lynx-g5300q-240919-241106-B-12612898.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other radio radio-lynx-g5300q-240919-241106-B-12612898.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
...
fastboot --skip-reboot -w update image-lynx-ap4a.250205.002.zip || exit /B 1
