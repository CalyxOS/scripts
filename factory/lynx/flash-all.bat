...
fastboot flash --slot=other bootloader bootloader-lynx-lynx-14.4-11458464.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other bootloader bootloader-lynx-lynx-14.4-11458464.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other radio radio-lynx-g5300q-231218-240202-B-11396366.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
ping -n 5 127.0.0.1 >nul
fastboot flash --slot=other radio radio-lynx-g5300q-231218-240202-B-11396366.img || exit /B 1
fastboot --set-active=other reboot-bootloader || exit /B 1
...
fastboot --skip-reboot -w update image-lynx-ap1a.240405.002.a1.zip || exit /B 1
